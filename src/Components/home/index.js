...
const Home = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      },
      {
        ...
        description: 'Spiritual rituals needs to be performed as part of remedy.',
        price: '',
      },
  ];
  ...
  return (
    <div>
      {/* banner Section */}
      <div className="bg-cover bg-center h-72 flex flex-col items-center justify-center text-white" style={{ backgroundImage: 'url("https://res.cloudinary.com/dryli2l24/image/upload/v1705665116/hero-sec-bg-img_zfhaer.png")' }}>
      ...
      <div className="home-container mt-8">
        ...
        <div className='flex flex-col mb-4 mt-8 md:mt-16 h-64 p-4 md:p-32 justify-center items-center bg-sky-800'>
